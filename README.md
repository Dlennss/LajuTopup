...
Gerak maju, tajam dan dinamis. Isi ulang, terus melaju.
...
Logo, banner, nama tampilan, metadata, font dan warna memakai identitas LajuTopup.
...
Alamat lokal: http://localhost:3106
...
Konfigurasikan pulsa-be/.env berdasarkan .env.example. Gunakan database lajutopup
dan akun H2HR yang ditetapkan untuk aplikasi ini. Jalankan migrasi sesuai dokumentasi
proyek asal, lalu jalankan go run . dari pulsa-be. Port backend: 8106.
...
lalu arahkan service khusus lajutopup ke release tersebut.
