...
const services = [
  { label: "Pulsa", href: "/user/pulsa", icon: `${assetBase}/05_service_icons/icon_pulsa.png` },
  { label: "Paket Data", href: "/user/paket-data", icon: `${assetBase}/05_service_icons/icon_paket_data.png` },
  { label: "PLN", href: "/user/listrik", icon: `${assetBase}/05_service_icons/icon_pln.png` },
  { label: "Game", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_game.png` },
  { label: "E-Wallet", href: "/user/ewallet", icon: `${assetBase}/05_service_icons/icon_ewallet.png` },
  { label: "Tagihan", href: "/user/listrik/tagihan", icon: `${assetBase}/05_service_icons/icon_tagihan.png` },
  { label: "TV Digital", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_tv.png` },
  { label: "Telkom", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_telkom.png` },
  { label: "PDAM", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_pdam.png` },
  { label: "Internet", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_internet.png` },
  { label: "Lainnya", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_lainnya.png` },
  { label: "Semua", href: "/user/kategori", icon: `${assetBase}/05_service_icons/icon_semua.png` },
];
...
export function LajuTopupHomeScreen({ user, profile }: LajuTopupHomeScreenProps) {
    ...
    <main className="min-h-svh bg-[#f6f4f3] pb-28 text-slate-950">
      <section className="-mt-10 px-4">
        <div className="relative z-10 overflow-hidden rounded-[24px] bg-white p-4 shadow-[0_18px_38px_rgba(80,39,35,0.13)] ring-1 ring-slate-950/[0.04]">
          <div className="grid grid-cols-[1fr_112px] gap-3">
            <Link href="/user/saldo" prefetch={false} className="flex min-w-0 items-center gap-4">
      ...
      <section className="mt-5 px-4">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/user/kategori" prefetch={false} className="inline-flex items-center gap-1 text-[13px] font-semibold text-slate-500">
            Lihat Semua
      ...
      <section className="mt-6 px-4">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link href="/user/transaksi" prefetch={false} className="inline-flex items-center gap-1 text-[13px] font-semibold text-slate-500">
            Lihat Semua
            <ChevronRight className="h-4 w-4" strokeWidth={2.4} />
          </Link>
        </div>
