...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | LajuTopup",
      description: "Cek dan bayar tagihan gas PGN di LajuTopup.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN LajuTopup`,
    description: `Cek dan bayar tagihan ${brand.nama} di LajuTopup dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
