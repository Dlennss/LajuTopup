...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | LajuTopup",
      description: "Beli paket atau bayar layanan TV berlangganan di LajuTopup.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan LajuTopup`,
    description: `Beli paket atau bayar layanan ${brand.nama} di LajuTopup dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
