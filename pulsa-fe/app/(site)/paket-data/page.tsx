...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | LajuTopup",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di LajuTopup dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
