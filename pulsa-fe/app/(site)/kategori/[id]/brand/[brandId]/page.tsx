...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} LajuTopup`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di LajuTopup.`,
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} LajuTopup`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di LajuTopup.`,
    path: `/kategori/${id}/brand/${brandId}`,
