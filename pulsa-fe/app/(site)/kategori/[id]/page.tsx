...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | LajuTopup`,
      description: "Layanan digital LajuTopup.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | LajuTopup",
      description: "Lihat kategori produk LajuTopup.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | LajuTopup`,
    description: `Lihat pilihan brand dan produk ${category.nama} di LajuTopup.`,
    path: `/kategori/${id}`,
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | LajuTopup`,
    description: `Lihat pilihan brand dan produk ${categoryName} di LajuTopup.`,
    path: `/kategori/${id}`,
