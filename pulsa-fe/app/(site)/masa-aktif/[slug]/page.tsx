...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Masa Aktif Semua Operator | LajuTopup",
      description: "Perpanjang masa aktif nomor Anda di LajuTopup.",
      path: "/masa-aktif",
    });
  }
  ...
  return buildPageMetadata({
    title: `Perpanjang Masa Aktif ${brandTitle} | LajuTopup`,
    description: lowestPrice
      ? `Perpanjang masa aktif ${brandTitle} di LajuTopup. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Perpanjang masa aktif ${brandTitle} di LajuTopup dengan pilihan produk yang jelas.`,
...
export default async function MasaAktifBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Perpanjang Masa Aktif ${brandTitle} | LajuTopup`,
    description: `Perpanjang masa aktif ${brandTitle} di LajuTopup dengan pilihan produk yang jelas.`,
    path: `/masa-aktif/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah masa aktif ${brandTitle} di LajuTopup tersedia dalam beberapa pilihan?`,
      answer: `Ya. LajuTopup menampilkan produk masa aktif ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara memperpanjang masa aktif ${brandTitle} di LajuTopup?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum maupun member LajuTopup untuk kebutuhan pribadi dan penjualan ulang.`,
    },
  ]);
