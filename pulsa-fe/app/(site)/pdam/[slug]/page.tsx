...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | LajuTopup",
      description: "Cek dan bayar tagihan PDAM di LajuTopup.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM LajuTopup`,
    description: `Cek dan bayar tagihan ${brand.nama} di LajuTopup dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
