...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | LajuTopup",
      description: "Pilih produk aktivasi perdana operator di LajuTopup.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | LajuTopup`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di LajuTopup. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di LajuTopup dengan pilihan yang jelas.`,
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | LajuTopup`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di LajuTopup dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di LajuTopup tersedia lengkap?`,
      answer: `Ya. LajuTopup menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di LajuTopup?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member LajuTopup untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
