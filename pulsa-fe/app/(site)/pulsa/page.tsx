...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa Semua Operator | LajuTopup",
  description: "Isi pulsa Telkomsel, Indosat, XL, Axis, Smartfren, dan operator lain di LajuTopup dengan pilihan nominal yang jelas dan transaksi cepat.",
  path: "/pulsa",
