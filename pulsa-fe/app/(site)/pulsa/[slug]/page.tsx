...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!pulsaCategory) {
    return buildPageMetadata({
      title: "Pulsa Operator | LajuTopup",
      description: "Isi pulsa operator favorit Anda di LajuTopup.",
      path: "/pulsa",
    });
  }
  ...
  return buildPageMetadata({
    title: `Isi Pulsa ${brandTitle} Online | LajuTopup`,
    description: lowestPrice
      ? `Isi pulsa ${brandTitle} online di LajuTopup dengan nominal lengkap. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Isi pulsa ${brandTitle} online di LajuTopup dengan nominal lengkap dan transaksi cepat.`,
    path: `/pulsa/${slug}`,
...
export default async function GuestPulsaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Isi Pulsa ${brandTitle} Online | LajuTopup`,
    description: `Isi pulsa ${brandTitle} online di LajuTopup dengan nominal lengkap dan transaksi cepat.`,
    path: `/pulsa/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah nominal pulsa ${brandTitle} di LajuTopup lengkap?`,
      answer: `Ya. LajuTopup menampilkan pilihan nominal pulsa ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara beli pulsa ${brandTitle} di LajuTopup?`,
      answer: `Pilih nominal pulsa ${brandTitle}, masukkan nomor tujuan, lalu lanjutkan pembayaran sesuai metode yang tersedia.`,
    },
    {
      question: `Apakah pembelian pulsa ${brandTitle} di LajuTopup bisa untuk calon member dan member?`,
      answer: `Bisa. Halaman ini bisa dipakai pembeli umum, dan member LajuTopup juga bisa memanfaatkan pilihan produk yang sama untuk transaksi harian.`,
    },
  ]);
