...
const pageTitle = "Privacy Policy LajuTopup | Website and Android App";
const pageDescription =
  "Privacy policy for LajuTopup website and Android application, including account data, transactions, security, and Google sign-in usage.";
