...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug !== "kesehatan" && slug !== "ketenagakerjaan") {
    return buildPageMetadata({
      title: "BPJS | LajuTopup",
      description: "Cek dan bayar BPJS di LajuTopup.",
      path: "/bpjs",
    });
  }
  ...
  return buildPageMetadata({
    title: `${title} | LajuTopup`,
    description: `Cek dan bayar ${title} di LajuTopup dengan alur yang ringkas.`,
    path: `/bpjs/${slug}`,
