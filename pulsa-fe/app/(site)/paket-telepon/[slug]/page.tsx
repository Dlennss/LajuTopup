...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!phoneCategory) {
    return buildPageMetadata({
      title: "Paket Telepon Semua Operator | LajuTopup",
      description: "Pilih paket telepon operator di LajuTopup.",
      path: "/paket-telepon",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Telepon ${brandTitle} | LajuTopup`,
    description: lowestPrice
      ? `Pilih paket telepon ${brandTitle} di LajuTopup. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih paket telepon ${brandTitle} di LajuTopup dengan pilihan produk yang jelas.`,
...
export default async function GuestPaketTeleponBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Telepon ${brandTitle} | LajuTopup`,
    description: `Pilih paket telepon ${brandTitle} di LajuTopup dengan pilihan produk yang jelas.`,
    path: `/paket-telepon/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket telepon ${brandTitle} di LajuTopup tersedia dalam banyak pilihan?`,
      answer: `Ya. LajuTopup menampilkan paket telepon ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli paket telepon ${brandTitle} di LajuTopup?`,
